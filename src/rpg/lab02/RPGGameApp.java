...
public class RPGGameApp {
    public static void main(String[] args) {
        ...
        Character warrior = new Character("Arthur", 10, 1500, 10, swordWeapon, "Warrior");
        Character mage = new Character("Merlin", 12, 800, 5, staffWeapon, "Mage");
        Healer healer = new Healer("Elara", 9, 1000, 8, staffHealer, 30);
